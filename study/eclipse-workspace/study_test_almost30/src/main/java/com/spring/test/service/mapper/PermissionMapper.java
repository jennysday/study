...
public class PermissionMapper {
	...
	//사용자 아이디에 저장된 직무 코드에 해당하는 기능 확인
	public ProgramVO getTitledetail_function(ProgramVO pgmvo) throws Exception {
		return mybatis.selectOne("permission.getTitledetail_function", pgmvo);
	}
