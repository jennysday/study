					...
					<tr>
						...
						<td class="le_td">
							<span class="pg_box">
								...
								<input type="checkbox" id="pgm_create" name="pgm_create" onclick='getCheckboxValue(event)' value="${result2.program.pgm_create}">
								
								<label for="pgm_read">조회</label>
								<!-- <input type="checkbox" id="pgm_read" name="pgm_function" value="조회" onclick='getCheckboxValue(event)'> --> 
								<input type="checkbox" id="pgm_read" name="pgm_read" onclick='getCheckboxValue(event)' value="${result2.program.pgm_read}">
								
								<label for="pgm_update">수정</label>
								<!-- <input type="checkbox" id="pgm_update" name="pgm_function" value="수정" onclick='getCheckboxValue(event)'> --> 
								<input type="checkbox" id="pgm_update" name="pgm_update" onclick='getCheckboxValue(event)' value="${result2.program.pgm_update}">
								
								<label for="pgm_delete">삭제</label>
								<!-- <input type="checkbox" id="pgm_delete" name="pgm_function" value="삭제" onclick='getCheckboxValue(event)'> --> 
								<input type="checkbox" id="pgm_delete" name="pgm_delete" onclick='getCheckboxValue(event)' value="${result2.program.pgm_delete}">
							</span>
						</td>
...
function delProgram() {
	...
	if(${sessionScope.user.user_id != null}){
		...
		if(chk) {
			location.href="delProgram?pgm_id=${result2.program.pgm_id}";
		}	
	} else {
		alert("로그인 해주세요!");
		location.href="login";
