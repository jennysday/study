...
public class PermissionController {
	...
	public void regTitledetail(ProgramVO pgmvo, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		result = service.regTitledetail(pgmvo,request,response);
		model.addAttribute("result", result);
	}
	...
	public String getTitleList(PagingVO pagevo, Model model, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		result = service.getProgramList(pagevo, session);
		System.out.println("프로그램 조회>>"+result);
		...
		Map<String, Object> result2 = new HashMap<String, Object>();
		result2 = service.getTitleMstList(pagevo, session);
		System.out.println("직무 마스터 조회>>"+result2);
