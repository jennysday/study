...
<body>
	...
	<div class="wrap">
		...
		<div class="search">
			...
			<span>직무코드 : &nbsp;</span> <span class="underLine">${sessionScope.user.titmst_id} &nbsp; ${sessionScope.user.titmst_name} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
			...
			<form action="searchTitleList" method="post" name="searchTitleForm" id="searchTitleForm">
				<input type="hidden" name="titdet_titmst_id" id="titdet_titmst_id" value="${sessionScope.user.titmst_id}">
			</form>
			</div>
		</div>
		...
		<div class="section">
			<form action="updateTitle" method="post" name="TitleForm" id="TitleForm" target="iframe">
				<table class="table_left">
					<tr>
						<th>프로그램ID</th>
						<td class="left"><c:out value="${result2.title.titdet_pgm_id}"></c:out></td>
						<td> <input type="text" name="titdet_titmst_id" id="titdet_titmst_id" value="${result2.title.titdet_titmst_id}"> </td>
						<td> <input type="text" name="titdet_pgm_id" id="titdet_pgm_id" value="${result2.title.titdet_pgm_id}"> </td>
					</tr>
					<tr>
