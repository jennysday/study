			...
			<form action="regTitledetail" method="post" name="regTitledetailForm" id="regTitledetailForm" target="iframe">
				<table>
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="pgm_id" id="pgm_id" value="${result3.program.pgm_id}" autocomplete="off" style="width: 252px;">
						</td>  
					</tr>
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="pgm_name" id="pgm_name" value="${result3.program.pgm_name}" autocomplete="off" style="width: 252px;">
						</td>  
					</tr>
