...
public interface PermissionService {
	...
	//사용자 등록
	void regUser(ProgramVO uservo, HttpServletRequest request, HttpServletResponse response, HttpSession sessionss) throws Exception;
	...
	//사용자 수정
	void updateUser(ProgramVO uservo, String user_id, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception;
