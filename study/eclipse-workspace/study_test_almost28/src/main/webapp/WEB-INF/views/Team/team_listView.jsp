					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="team" items="${result.teamList}">
								<tr id="mouse" onClick="location.href='getTeamListView?team_id=${team.team_id}'">
				...
				<div class="btn_box">
					<div>
						<ul>
							...
							<li><input type="hidden" id="titdet_function" value="${funct.titdet_function}" readonly="readonly"></li>
