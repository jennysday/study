				...
				<table>
					...
					<tr>
						...
						<td class="pg_box">
							...
							<input type="checkbox" id="pgm_create" name="pgm_create" value="${result.program.pgm_create}"><%-- ${result.program.pgm_create} --%>
							...
							<input type="checkbox" id="pgm_read" name="pgm_read" value="${result.program.pgm_read}"><%-- ${result.program.pgm_read} --%>
							...
							<input type="checkbox" id="pgm_update" name="pgm_update" value="${result.program.pgm_update}"><%-- ${result.program.pgm_update} --%>
							...
							<input type="checkbox" id="pgm_delete" name="pgm_delete" value="${result.program.pgm_delete}"><%-- ${result.program.pgm_delete} --%>
						</td>
