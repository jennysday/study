	...
	<div class="wrap">
		...
		<div class="search">
			<div class="search_txt">
				<form action="getProgramList" method="post" name="searchPrgmForm" id="searchPrgmForm">
						<span>부서명 : &nbsp;</span> 
						<select name="pgm_id" class="teamList">
						     <c:forEach var="result" items="${result3.programList}">
			...
			<table id="gcTable" class="tablesorter">
				...
				<tbody>
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="program" items="${result.searchList}">
