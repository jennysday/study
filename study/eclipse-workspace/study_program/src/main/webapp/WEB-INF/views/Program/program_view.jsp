				...
				<table>
					...
					<tr>
						...
						<td class="pg_box">
							...
							<input type="checkbox" id="pgm_create" name="pgm_create" value="입력">
							...
							<input type="checkbox" id="pgm_read" name="pgm_read" value="조회">
							...
							<input type="checkbox" id="pgm_update" name="pgm_update" value="수정">
							...
							<input type="checkbox" id="pgm_delete" name="pgm_delete" value="삭제">
						</td>
