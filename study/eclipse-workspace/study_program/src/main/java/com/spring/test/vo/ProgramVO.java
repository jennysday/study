...
public class ProgramVO {
	...
	private String pgm_create;
	private String pgm_read;
	private String pgm_update;
	private String pgm_delete;
	...
	public String getPgm_create() {
		return pgm_create;
	}
	public void setPgm_create(String pgm_create) {
		this.pgm_create = pgm_create;
	}
	public String getPgm_read() {
		return pgm_read;
	}
	public void setPgm_read(String pgm_read) {
		this.pgm_read = pgm_read;
	}
	public String getPgm_update() {
		return pgm_update;
	}
	public void setPgm_update(String pgm_update) {
		this.pgm_update = pgm_update;
	}
	public String getPgm_delete() {
		return pgm_delete;
	}
	public void setPgm_delete(String pgm_delete) {
