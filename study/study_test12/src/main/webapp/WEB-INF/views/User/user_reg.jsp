			...
			<form action="regUser" method="post" name="regUserForm" id="regUserForm" target="iframe">
				<table>
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="user_titmst_id1" id="user_titmst_id1" class="box" autocomplete="off" maxlength='8' onkeydown="upteam_chk()" oninput = "checkTitmst()">
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="user_titmst_id2" id="user_titmst_id2" class="box" autocomplete="off" maxlength='8' onkeydown="upteam_chk()" oninput = "checkTitmst()">
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="user_titmst_id3" id="user_titmst_id3" class="box" autocomplete="off" maxlength='8' onkeydown="upteam_chk()" oninput = "checkTitmst()">
					...
					<tr>
						...
						<td class="left"><input type="text" name="user_dataaccess" id="user_dataaccess" class="box" autocomplete="off" maxlength='20'></td>
					</tr>
				...
				<div class="btn_box_reg">
					<div>
						<ul>
							...
							<li><a href="javascript:regUser()" class="btn">등록</a></li>
						</ul>
					</div>
				</div>
			</form>
