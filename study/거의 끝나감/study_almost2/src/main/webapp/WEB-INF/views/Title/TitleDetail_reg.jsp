			...
			<form action="regTitledetail" method="post" name="regTitledetailForm" id="regTitledetailForm" target="iframe">
				<table>
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="titdet_pgm_id" id="titdet_pgm_id" value="${result3.program.pgm_id}" autocomplete="off" style="width: 252px;" readonly="readonly">
						</td>  
					</tr>
					...
					<tr>
						...
						<td class="left">
							<input type="text" name="pgm_name" id="pgm_name" value="${result3.program.pgm_name}" autocomplete="off" style="width: 252px;" readonly="readonly">
						</td>  
					</tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="program" items="${result2.programList}">
								<tr id="mouse" onClick="location.href='regTitledetailView?pgm_id=${program.pgm_id}'">
...
$(document).ready(function(){
	...
	$("input[name=pgm_create]").val();
	$("input[name=pgm_read]").val();
	$("input[name=pgm_update]").val();
	$("input[name=pgm_delete]").val();
