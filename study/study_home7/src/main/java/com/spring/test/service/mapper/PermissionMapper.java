...
import com.spring.test.vo.TeamCodeVO;
...
public class PermissionMapper {
    ...
    //상위부서 등록 여부 확인
    public List<TeamCodeVO> upteamList () {
    	return mybatis.selectList("permission.upteamList");	
    }
	...
	//상위부서 조회
	public List<TeamVO> getupteamList(TeamVO teamvo) throws Exception {
		return mybatis.selectList("permission.getupteamList", teamvo);
	}
