...
<body>
	...
	<div class="wrap">
		...
		<div class="search">
			...
			<form action="searchTitleList2" method="post" name="searchTitleForm" id="searchTitleForm">
		...
		<div class="section">
			<form action="updateTeam" method="post" name="TeamForm" id="TeamForm" target="iframe">
				<table class="table_left">
					...
					<tr>
						<th>최종사용자</th>
						<td><input type="hidden" name="team_user_id" id="team_user_id" value="${sessionScope.user.user_id}">${result2.title.titdet_user_id}</td>
					</tr>
				</table>
