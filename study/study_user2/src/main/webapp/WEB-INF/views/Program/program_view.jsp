				...
				<table>
					...
					<tr>
						...
						<td class="pg_box">
							...
							<!-- <input class = "chkbox" type="checkbox" id="pgm_create" name="pgm_function" value="입력" onclick='getCheckboxValue(event)'>  -->
							<input type="checkbox" id="pgm_create" name="pgm_create" value="${result.program.pgm_create}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_create} --%>
							
							<label for="pgm_read">조회</label>
							<!-- <input class = "chkbox" type="checkbox" id="pgm_read" name="pgm_function" value="조회" onclick='getCheckboxValue(event)'>  -->
							<input type="checkbox" id="pgm_read" name="pgm_read" value="${result.program.pgm_read}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_read} --%>
							
							<label for="pgm_update">수정</label>
							<!-- <input class = "chkbox" type="checkbox" id="pgm_update" name="pgm_function" value="수정" onclick='getCheckboxValue(event)'> -->
							<input type="checkbox" id="pgm_update" name="pgm_update" value="${result.program.pgm_update}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_update} --%>
							
							<label for="pgm_delete">삭제</label>
							<!-- <input class = "chkbox" type="checkbox" id="pgm_delete" name="pgm_function" value="삭제" onclick='getCheckboxValue(event)'>  -->
							<input type="checkbox" id="pgm_delete" name="pgm_delete" value="${result.program.pgm_delete}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_delete} --%>
						</td>
					...
					<tr>
						...
						<td class="left"><input type="text" name="pgm_status" id="pgm_status" class="box" autocomplete="off" maxlength='4' value="${result2.program.pgm_status}"></td>
					</tr>
...
$(document).ready(function(){
	...
	$("input[name=pgm_create]").filter("[value='true']").prop("checked",true);
	$("input[name=pgm_read]").filter("[value='true']").prop("checked",true);
	$("input[name=pgm_update]").filter("[value='true']").prop("checked",true);
	$("input[name=pgm_delete]").filter("[value='true']").prop("checked",true);
...
function updateProgram() {
	...
	console.log(form.pgm_name.value);
	/*** 프로그램명 유효성 검사 ***/
