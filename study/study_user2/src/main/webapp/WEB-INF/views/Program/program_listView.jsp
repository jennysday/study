				...
				<table>
					...
					<tr>
						...
						<td class="pg_box">
							...
							<input type="checkbox" id="pgm_create" name="pgm_create" value="${result2.program.pgm_create}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_create} --%>
							...
							<input type="checkbox" id="pgm_read" name="pgm_read" value="${result2.program.pgm_read}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_read} --%>
							...
							<input type="checkbox" id="pgm_update" name="pgm_update" value="${result2.program.pgm_update}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_update} --%>
							...
							<input type="checkbox" id="pgm_delete" name="pgm_delete" value="${result2.program.pgm_delete}" onclick='getCheckboxValue(event)'><%-- ${result.program.pgm_delete} --%>
						</td>
					...
					<tr>
						...
						<td class="left"><input type="text" name="pgm_status" id="pgm_status" class="box2" autocomplete="off" maxlength='4' value="${result2.program.pgm_status}"></td>
					</tr>
					
					
					<tr>
						<th>최종사용자</th>
						<td class="left"><c:out value="${result2.program.pgm_user_id}"></c:out></td>
