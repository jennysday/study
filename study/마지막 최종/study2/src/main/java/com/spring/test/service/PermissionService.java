...
public interface PermissionService {
	...
	//부서 수정
	void updateTeam(TeamVO teamvo, HttpServletRequest request, HttpServletResponse response) throws Exception;
	...
	//사용자 등록
	void regUser(ProgramVO uservo, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception;
	...
	//사용자 수정
	void updateUser(ProgramVO uservo, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception;
	...
	//직무 마스터 - 조회
	Map<String, Object> getTitleMstList3() throws Exception;
	...
	//직무 상세 - 등록
	void regTitledetail(ProgramVO pgmvo, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception;
	...
	//직무 수정
	void updateTitle(ProgramVO pgmvo, HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception;
	
	//직무 삭제
	void delTitle(ProgramVO pgmvo, HttpServletResponse response, HttpSession session) throws Exception;
	...
	//팀 검색 조회
	Map<String, Object> searchTeamList(ProgramVO pgmvo, HttpSession session) throws Exception;
	//사용자 검색 조회
	Map<String, Object> searchUserList(ProgramVO pgmvo, HttpSession session) throws Exception;
	//사용자 검색 조회
	Map<String, Object> searchUser(ProgramVO pgmvo, HttpSession session) throws Exception;
	//프로그램 검색 조회
	Map<String, Object> searchPrgmList(ProgramVO pgmvo, HttpSession session) throws Exception;
	//직무 검색 조회
