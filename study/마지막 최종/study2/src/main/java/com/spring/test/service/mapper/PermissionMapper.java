...
public class PermissionMapper {
	...
	public int searchTeamListCount(ProgramVO pgmvo) {
		return mybatis.selectOne("permission.searchTeamListCount", pgmvo);
	}
	...
	//직무 검색 조회
	public List<ProgramVO> searchTitleList2() throws Exception {
		System.out.println("searchTitleList2>>");
		return mybatis.selectList("permission.searchTitleList2");
	}
	
	//직무 검색 조회
	public List<ProgramVO> getTitleMstList3() throws Exception {
		System.out.println("getTitleMstList3>>");
		return mybatis.selectList("permission.getTitleMstList3");
	}
